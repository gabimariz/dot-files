return {
  ...
  config = function()
    ...
    local colors = {
      BG = theme.get_by_name("Normal", "bg"),
      FG = theme.get_by_name("Normal", "fg"),
      YELLOW = theme.get_by_name("CurSearch", "bg"),
      CYAN = theme.get_by_name("SpecialComment", "fg"),
      DARKBLUE = theme.get_by_name("Visual", "bg"),
      GREEN = theme.get_by_name("String", "fg"),
      ORANGE = theme.get_by_name("Substitute", "bg"),
      VIOLET = theme.get_by_name("Float", "fg"),
      MAGENTA = theme.get_by_name("Float", "fg"),
      BLUE = theme.get_by_name("TabLineSel", "bg"),
      RED = theme.get_by_name("Error", "fg"),
    }
    ...
    local icon_sets = {
      stars = { "", "", "󰫣", "󰫢", "✶", "✷", "✸", "󱝁" }, -- Set of star-like icons
      skulls = { "", "󰯆", "󰯈", "󱄲", "󱄳" },
      moons = { "", "", "󰽥", "󰽧", "", "", "󰽨" },
